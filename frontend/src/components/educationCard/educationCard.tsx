    ...
    return(
        <div className="card p-2  min-w-80 lg:min-w-90     border-2 bg-[#F8FAFF] border-[#E1E2F3] rounded-3xl   flex flex-col gap-4">
            ...
            <div className="px-2 flex flex-col gap-4">
                <h5 className="font-semibold">Genie logiciel</h5>
            ...
            <div className="course-info  gap-2 flex items-center justify-between">
                ...
                <div className="difficulty-course items-center  gap-3 flex-col     rounded-3xl flex border-[#00c93257]">
                    ...
                    <p className="text-[#ffffff] font-medium  border bg-[#0028c9] px-2 border-[#0028c957] rounded-3xl" style={{color:"white", fontSize:"17px"}}>L3</p>
                </div>
            ...
            <div className="main-card-info flex justify-between items-center px-2 mt-4">
                ...
                <button onClick={()=>history("/educationCourse")} className="enroll-btn cta-education cta cta main-btn text-[12px] px-1 py-3  squircle sm:px-5 sm:py-3 sm:text-[16px] md:px-5 md:py-3 md:text-[18px] lg:px-5 lg:py-3 lg:text-[18px]">Enroll Now</button>
            </div>
            </div>
