...
function TeachCourseCard({ onClick,title,visibility,photo }: TeachCourseCardProps){
    return(
        <div  className="teach-card px-2 w-full md:w-80 lg:min-w-90     py-2 border-2 bg-[#F8FAFF] border-[#E1E2F3] rounded-3xl   flex flex-col gap-4">
            <div style={{backgroundImage:`url(${import.meta.env.VITE_API_FILE_URL}/${photo})`}} className="thumbnail rounded-3xl">
