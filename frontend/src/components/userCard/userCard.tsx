...
function UserCard({isfavorite,enr,liked,onDelete,type}:params){
  ...
  const navigate = useNavigate()
    ...
    return(
        <><div className="user-card px-2 min-w-80 group   lg:min-w-90 py-2 pb-4 border-2 bg-[#F8FAFF] border-[#E1E2F3] rounded-3xl   flex flex-col gap-4">
            ...
            <button onClick={()=>navigate("/enr/"+enr?.id)} className={` ${type == "education"? "bg-[#d98230] group-hover:bg-[#ff7b00]":"bg-[#3359cb] group-hover:bg-[#003fed]"} main-btn text-[12px]  px-2 py-3 flex user-btn gap-2 items-center justify-center  squircle sm:px-12 sm:py-3 sm:text-[16px] md:px-8 md:py-3 md:text-[18px] lg:px-12 lg:py-2 lg:text-[18px]`}>{
