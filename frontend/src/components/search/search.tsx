    ...
    return (
        <section className="mt-5 w-full">
            <div className="search-wrapper flex justify-center">
                <div className="sm:w-[70%] md:w-[50%] w-[90%] flex sm:h-12.5 md:h-15 items-center pr-2 justify-between rounded-3xl border-[#a8c4e7] border-2 bg-gray-100 transition-all ease-in-out">
