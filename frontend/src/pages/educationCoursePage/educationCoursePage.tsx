            ...
            <div className="first-level-content relative flex gap-6">
                ...
                <div className="payement hidden lg:flex sticky top-6 w-[30%] h-fit bg-white p-10 rounded-3xl  flex-col gap-6 shadow-lg border-2 border-[#E1E2F3]">
                    <div className="flex justify-between items-center">
                      <p style={{color:"#1F1CD9",fontWeight:"600"}}> <span style={{color:"#1f1cd99c"}}>Computer science /</span>  L3  </p>  
                      
                    
                    </div>
                    <h3 className="price-tag">6000 DA</h3>
                    <div className="pay flex gap-3 items-center">
                        <button className="cta main-btn text-[12px] px-2 py-3  squircle sm:px-12 sm:py-3 sm:text-[16px] md:px-12 md:py-3 cta-education md:text-[18px] w-[80%] lg:px-12 h-[70%] lg:py-5 lg:text-[18px]">Buy now</button>
                ...
                <div className="payement-md flex lg:hidden fixed justify-between bottom-0 p-5 bg-[#0c2443f7] h-[150px] border-t border-t-[#000000] w-full right-0 left-0 z-10">
                    ...
                    <div className="btns flex-1 flex flex-col items-center">
                        <button className="cta main-btn text-[12px] px-2 py-3  squircle sm:px-12 sm:py-3 sm:text-[16px] md:px-12  cta-education md:py-3 md:text-[18px] w-[80%] lg:px-12 h-[70%] lg:py-5 lg:text-[18px]">Buy now</button>
