...
function AddEdCourse(){
    ...
    }, [step, selected, category,subcategory]);
    return(
        <div className="main  bg-[#F7F7F7] items-center    flex flex-col gap-20   h-fit w-full" >
            ...
            {step === 1 && <div className="flex flex-col gap-4 items-center">
                ...
                <div className="flex flex-row gap-8 w-[100%] flex-wrap justify-center lg:w-1/2 lg:flex-nowrap mt-10 ">
                    <div className="categories w-2/3 flex flex-row flex-wrap gap-4">
                        {DomainsEd.filter((Domain)=>Domain.label==category).map((domain)=>(
                ...
                <div className="bg-white btn-div mt-auto  w-full p-8 flex justify-between   ">
                    ...
                    {step<4 && <button onClick={handleSteps} disabled={disabled} className={`${disabled ? "disabled-education":"cta cta-education"}  self-end  ml-auto rounded-3xl    gap-2 font-bold p-5`}>Continue</button>}
                    {step == 4 && <button onClick={handleStep4} disabled={disabled} className={`${disabled ? "disabled-education":"cta cta-education"}  self-end  ml-auto rounded-3xl    gap-2 font-bold p-5`}>Save to Draft</button>}
